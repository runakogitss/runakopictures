        ...
        contactForm.addEventListener('submit', async function (e) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (data.errors) {
                        showFormMessage('❌ Please check your form fields: ' + data.errors.map(error => error.message).join(', '), 'error');
                    } else {
                        showFormMessage('❌ There was a problem sending your message. Please try again or email me directly at runakopictures@gmail.com', 'error');
                    }
                }
            } catch (error) {
                // Network error
                showFormMessage('❌ Network error. Please check your connection and try again, or email me directly at runakopictures@gmail.com', 'error');
